...
syn region  gitcommitSelected	start=/^# Changes to be committed:/ end=/^#$\|^#\@!/ contains=gitcommitHeader,gitcommitHead,gitcommitSelectedType,gitcommitNewFileType,gitcommitModifiedFileType,gitcommitDeletedFileType fold
...
syn match   gitcommitNewFileType      "\t\@<=new file: "he=e-2 contained containedin=gitcommitComment nextgroup=gitcommitNewFile skipwhite
syn match   gitcommitModifiedFileType "\t\@<=modified: "he=e-2 contained containedin=gitcommitComment nextgroup=gitcommitModifiedFile skipwhite
syn match   gitcommitDeletedFileType  "\t\@<=deleted: "he=e-2  contained containedin=gitcommitComment nextgroup=gitcommitDeletedFile skipwhite

syn match   gitcommitNewFile       ".\{-\}\%($\| -> \)\@=" contained nextgroup=gitcommitSelectedArrow
syn match   gitcommitModifiedFile  ".\{-\}\%($\| -> \)\@=" contained nextgroup=gitcommitSelectedArrow
syn match   gitcommitDeletedFile   ".\{-\}\%($\| -> \)\@=" contained nextgroup=gitcommitSelectedArrow
