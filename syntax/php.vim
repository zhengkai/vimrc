...
" Constants
syn keyword phpCoreConstant LOCK_SH LOCK_EX LOCK_UN LOCK_NB PHP_VERSION PHP_OS DEFAULT_INCLUDE_PATH PEAR_INSTALL_DIR PEAR_EXTENSION_DIR PHP_EXTENSION_DIR PHP_BINDIR PHP_LIBDIR PHP_DATADIR PHP_SYSCONFDIR PHP_LOCALSTATEDIR PHP_CONFIG_FILE_PATH PHP_OUTPUT_HANDLER_START PHP_OUTPUT_HANDLER_CONT PHP_OUTPUT_HANDLER_END E_ERROR E_WARNING E_PARSE E_NOTICE E_CORE_ERROR E_CORE_WARNING E_COMPILE_ERROR E_COMPILE_WARNING E_USER_ERROR E_USER_WARNING E_USER_NOTICE E_ALL  contained
...
syn keyword phpFunctions  array_change_key_case array_column array_chunk array_combine array_count_values array_diff_assoc array_diff_uassoc array_diff array_fill array_fill_keys array_filter array_flip array_intersect_assoc array_intersect array_key_exists array_keys array_map array_merge_recursive array_merge array_multisort array_pad array_pop array_push array_rand array_reduce array_reverse array_search array_shift array_slice array_splice array_sum array_udiff_assoc array_udiff_uassoc array_udiff array_unique array_unshift array_values array_walk array arsort asort compact count current each end extract in_array key krsort ksort list natcasesort natsort next pos prev range reset rsort shuffle sizeof sort uasort uksort usort contained
...
syn keyword phpFunctions  call_user_method_array call_user_method class_exists get_class_methods get_called_class get_class_vars get_class get_declared_classes get_object_vars get_parent_class is_a is_subclass_of method_exists contained
...
syn keyword phpFunctions  copcache_compile_file opcache_get_configuration opcache_get_status opcache_invalidate opcache_is_script_cached opcache_reset  contained
...
syn keyword phpFunctions  filter_has_var filter_id filter_var filter_var_array filter_input filter_input_array filter_list contained
syn keyword phpFunctions  debug_backtrace debug_print_backtrace error_clear_last error_log error_reporting error_get_last restore_error_handler set_error_handler set_exception_handler trigger_error user_error  contained
...
syn keyword phpFunctions  http_response_code hash hash_algos hash_copy hash_equals hash_file hash_final hash_hmac_file hash_hmac hash_init hash_pbkdf2 hash_update_file hash_update_stream hash_update header headers_list headers_sent setcookie  contained
...
syn keyword phpFunctions  msgpack_pack msgpack_unpack msession_connect msession_count msession_create msession_destroy msession_disconnect msession_find msession_get_array msession_get msession_getdata msession_inc msession_list msession_listvar msession_lock msession_plugin msession_randstr msession_set_array msession_set msession_setdata msession_timeout msession_uniq msession_unlock  contained
...
syn keyword phpFunctions  fastcgi_finish_request flush ob_clean ob_end_clean ob_end_flush ob_flush ob_get_clean ob_get_contents ob_get_flush ob_get_length ob_get_level ob_get_status ob_gzhandler ob_implicit_flush ob_list_handlers ob_start output_add_rewrite_var output_reset_rewrite_vars  contained
...
syn keyword phpFunctions  password_get_info password_hash password_needs_rehash password_verify contained
...
syn keyword phpFunctions  random_bytes random_int readline_add_history readline_clear_history readline_completion_function readline_info readline_list_history readline_read_history readline_write_history readline  contained
...
syn keyword phpFunctions  gzclose gzcompress gzdeflate gzencode gzdecode gzeof gzfile gzgetc gzgets gzgetss gzinflate gzopen gzpassthru gzputs gzread gzrewind gzseek gztell gzuncompress gzwrite readgzfile zlib_get_coding_type  contained
...
" Statement
syn keyword phpStatement  return break yield continue exit goto  contained

" Keyword
syn keyword phpKeyword  var const contained

" Type
syn keyword phpType bool[ean] int[eger] real double float string array object callable NULL  contained
